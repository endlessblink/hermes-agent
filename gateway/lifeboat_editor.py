...
EDITOR_SYSTEM = (
    ...
    "shape, make the choice concrete yourself — choose the moment, place, or "
    "small action that comes next — and then ask only for the detail needed to "
    "take that chosen step. The reply must name the anchor it chose (for example, "
    "this morning, yesterday evening, or the message he just wrote), and then ask "
