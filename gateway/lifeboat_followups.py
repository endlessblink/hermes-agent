...
def build_continuation_guidance(
    ...
    return (
        ...
        "then ask exactly one concrete next-step question that helps explore what still has force, or suggest one "
        "small next action only when the user is clearly asking for action. Do not answer your own "
...
def build_lifeboat_coaching_guidance(
    ...
    return (
        ...
        "specific detail with uncertainty, then ask exactly one concise question that opens the next "
        "piece of exploration. Do not answer your own question, give generic advice, offer a polished "
