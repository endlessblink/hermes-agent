...
export const zh: Translations = {
  ...
  assistantUi: {
    addStep: '添加步骤',
    approveExact: '批准精确更改',
    approvedAndSent: '已批准并发送',
    after: '更改后',
    baseRevision: '基准修订版',
    before: '更改前',
    canonicalPreview: '这是正式预览。只有明确批准后，才会执行精确更改。',
    correction: '更正或缺少的背景',
    correctionPlaceholder: '批准前写下需要的更改',
    doneEnough: '完成标准',
    estimateMinutes: '预计分钟',
    exactOperations: '精确操作',
    expired: '此预览已过期。请请求新的预览。',
    invalidDescription: 'Hermes 返回了不完整或无效的界面组件。',
    invalidTitle: '无法显示交互式助手',
    moveDown: '下移',
    moveUp: '上移',
    mutationFields: {
      canvasPosition: '画布位置',
      clientId: '新子任务标识',
      completedPomodoros: '已完成专注时段',
      description: '描述',
      doneEnough: '完成标准',
      estimateMinutes: '预计分钟',
      isCompleted: '已完成',
    ...
    no: '否',
    operationKinds: { create: '创建子任务', delete: '删除子任务', update: '更新子任务' },
    optional: '可选',
    preparing: '正在准备交互式助手…',
    previewLabel: 'FlowState 更改预览',
    remove: '移除',
    requestPreview: '请求新的预览',
    resend: '请求 Hermes 重新发送',
    resendPrompt: '交互式助手无法显示。请只重新发送一个完整且有效的 hermes-ui 组件，不要附加说明，并等待我的回复。',
    risk: '风险',
    scope: { 'full-delivery': '完整交付', 'next-move': '下一步', 'working-session': '工作时段' },
    sendFailed: '发送失败。你可以重试。',
    sending: '发送中…',
    sent: '已发送给 Hermes',
    step: '步骤',
    stoppingRule: '停止规则',
