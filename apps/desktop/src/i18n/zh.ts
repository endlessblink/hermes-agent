...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    deleteFolderConfirm: name => `删除“${name}”？其中的会话不会被删除，将移回会话列表。`,
    folderEmpty: '暂无会话 — 通过会话的 ⋯ 菜单移动到此处。',
    pinFolder: '固定到所有配置',
    unpinFolder: '取消固定到所有配置',
    folderPinnedBadge: '在所有配置中显示',
    reorderFolder: name => `重新排序文件夹 ${name}`,
    folderActionsFor: name => `文件夹 ${name} 的操作`,
  ...
  desktop: {
    ...
    restartToCopyImages: '重启 Hermes 桌面版以复制图片',
