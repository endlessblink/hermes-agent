...
export const ja = defineLocale({
  ...
  assistantUi: {
    addStep: '手順を追加',
    approveExact: '正確な変更を承認',
    approvedAndSent: '承認して送信済み',
    after: '変更後',
    baseRevision: '基準リビジョン',
    before: '変更前',
    canonicalPreview: '正式なプレビューです。明示的に承認した場合のみ、正確な変更が実行されます。',
    correction: '修正または不足している情報',
    correctionPlaceholder: '承認前に必要な変更を入力してください',
    doneEnough: '完了の基準',
    estimateMinutes: '見積もり時間（分）',
    exactOperations: '正確な操作',
    expired: 'このプレビューは期限切れです。新しいプレビューを依頼してください。',
    invalidDescription: 'Hermes が不完全または無効な UI を返しました。',
    invalidTitle: '対話型アシスタントを表示できませんでした',
    moveDown: '下へ移動',
    moveUp: '上へ移動',
    mutationFields: {
      canvasPosition: 'キャンバス位置',
      clientId: '新しいサブタスクID',
      completedPomodoros: '完了した集中セッション',
      description: '説明',
      doneEnough: '完了の基準',
      estimateMinutes: '見積もり時間（分）',
      isCompleted: '完了',
    ...
    no: 'いいえ',
    operationKinds: { create: 'サブタスクを作成', delete: 'サブタスクを削除', update: 'サブタスクを更新' },
    optional: '任意',
    preparing: '対話型アシスタントを準備中…',
    previewLabel: 'FlowState 変更プレビュー',
    remove: '削除',
    requestPreview: '新しいプレビューを依頼',
    resend: 'Hermes に再送を依頼',
    resendPrompt: '対話型アシスタントを表示できませんでした。説明を付けず、完全で有効な hermes-ui アーティファクトを1つだけ再送して、私の応答を待ってください。',
    risk: 'リスク',
    scope: { 'full-delivery': '完全な納品', 'next-move': '次の一手', 'working-session': '作業セッション' },
    sendFailed: '送信に失敗しました。再試行できます。',
    sending: '送信中…',
    sent: 'Hermes に送信済み',
    step: '手順',
    stoppingRule: '終了条件',
