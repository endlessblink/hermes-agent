...
export const en: Translations = {
  ...
  assistantUi: {
    addStep: 'Add step',
    approveExact: 'Approve exact changes',
    approvedAndSent: 'Approved and sent',
    after: 'After',
    baseRevision: 'Base revision',
    before: 'Before',
    canonicalPreview: 'Canonical preview. The exact change runs only after explicit approval.',
    correction: 'Correction or missing context',
    correctionPlaceholder: 'Write any change needed before approval',
    doneEnough: 'Done enough',
    estimateMinutes: 'Estimate minutes',
    exactOperations: 'Exact operations',
    expired: 'This preview expired. Request a new preview.',
    invalidDescription: 'Hermes returned an incomplete or invalid UI artifact.',
    invalidTitle: 'Interactive assistant could not be shown',
    moveDown: 'Move down',
    moveUp: 'Move up',
    mutationFields: {
      canvasPosition: 'Canvas position',
      clientId: 'New subtask identity',
      completedPomodoros: 'Completed focus sessions',
      description: 'Description',
      doneEnough: 'Done enough',
      estimateMinutes: 'Estimate minutes',
      isCompleted: 'Completed',
      order: 'Order',
      subtaskId: 'Subtask identity',
      title: 'Title'
    },
    no: 'No',
    operationKinds: { create: 'Create subtask', delete: 'Delete subtask', update: 'Update subtask' },
    optional: 'Optional',
    preparing: 'Preparing interactive assistant…',
    previewLabel: 'FlowState mutation preview',
    remove: 'Remove',
    requestPreview: 'Request a new preview',
    resend: 'Ask Hermes to resend',
    resendPrompt: 'The interactive assistant could not be rendered. Please resend it as one complete valid hermes-ui artifact, with no surrounding explanation, and wait for my response.',
    risk: 'Risk',
    scope: { 'full-delivery': 'Full delivery', 'next-move': 'Next move', 'working-session': 'Working session' },
    sendFailed: 'Send failed. You can retry.',
    sending: 'Sending…',
    sent: 'Sent to Hermes',
    step: 'Step',
