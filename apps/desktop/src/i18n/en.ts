...
export const en: Translations = {
  ...
  profiles: {
    ...
    autoColor: 'Auto',
    icon: 'Icon...',
    chooseIconFor: name => `Icon for ${name}`,
  ...
  sidebar: {
    ...
    customFolderDefaultName: 'New folder',
    ...
    deleteFolderConfirm: name => `Delete “${name}”? Its chats won't be deleted — they'll move back to Sessions.`,
    folderEmpty: 'No chats yet — move one here from its ⋯ menu.',
    pinFolder: 'Pin to all profiles',
    unpinFolder: 'Unpin from all profiles',
    folderPinnedBadge: 'Shown in all profiles',
    reorderFolder: name => `Reorder folder ${name}`,
    folderActionsFor: name => `Actions for folder ${name}`,
  ...
  desktop: {
    ...
    restartToCopyImages: 'Restart Hermes Desktop to copy images',
