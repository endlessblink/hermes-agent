...
export const zhHant = defineLocale({
  ...
  assistantUi: {
    addStep: '新增步驟',
    approveExact: '核准精確變更',
    approvedAndSent: '已核准並送出',
    after: '變更後',
    baseRevision: '基準修訂版',
    before: '變更前',
    canonicalPreview: '這是正式預覽。只有在明確核准後，才會執行精確變更。',
    correction: '修正或缺少的背景',
    correctionPlaceholder: '在核准前寫下需要的變更',
    doneEnough: '完成標準',
    estimateMinutes: '預估分鐘',
    exactOperations: '精確操作',
    expired: '此預覽已過期。請要求新的預覽。',
    invalidDescription: 'Hermes 傳回了不完整或無效的介面成品。',
    invalidTitle: '無法顯示互動式助理',
    moveDown: '下移',
    moveUp: '上移',
    mutationFields: {
      canvasPosition: '畫布位置',
      clientId: '新子任務識別碼',
      completedPomodoros: '已完成專注時段',
      description: '描述',
      doneEnough: '完成標準',
      estimateMinutes: '預估分鐘',
      isCompleted: '已完成',
    ...
    no: '否',
    operationKinds: { create: '建立子任務', delete: '刪除子任務', update: '更新子任務' },
    optional: '選填',
    preparing: '正在準備互動式助理…',
    previewLabel: 'FlowState 變更預覽',
    remove: '移除',
    requestPreview: '要求新的預覽',
    resend: '要求 Hermes 重新傳送',
    resendPrompt: '互動式助理無法顯示。請只重新傳送一個完整且有效的 hermes-ui 成品，不要加入其他說明，並等待我的回覆。',
    risk: '風險',
    scope: { 'full-delivery': '完整交付', 'next-move': '下一步', 'working-session': '工作時段' },
    sendFailed: '傳送失敗。你可以重試。',
    sending: '傳送中…',
    sent: '已傳送給 Hermes',
    step: '步驟',
    stoppingRule: '停止規則',
