...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    createFolder: '新增資料夾',
    customFolderDefaultName: '新增資料夾',
    newFolderTitle: '新增資料夾',
    renameFolderTitle: '重新命名資料夾',
    folderNamePlaceholder: '資料夾名稱',
    renameFolderAction: '重新命名資料夾',
    deleteFolderAction: '刪除資料夾',
    deleteFolderTitle: '刪除資料夾',
    deleteFolderConfirm: name => `刪除「${name}」？其中的對話不會被刪除，將移回工作階段清單。`,
    folderEmpty: '尚無對話 — 透過對話的 ⋯ 選單移動到此處。',
    pinFolder: '釘選到所有設定檔',
    unpinFolder: '取消釘選到所有設定檔',
    folderPinnedBadge: '在所有設定檔中顯示',
    reorderFolder: name => `重新排序資料夾 ${name}`,
    folderActionsFor: name => `資料夾 ${name} 的操作`,
  ...
  updates: {
    ...
    dirtyBody:
      'Hermes 已暫停更新，因為此原始碼檢出中有本機變更。請先提交或暫存它們，避免已可用的功能在重新建置時被隱藏或替換。',
  ...
  desktop: {
    ...
    restartToCopyImages: '重新啟動 Hermes Desktop 以複製圖片',
    imageDownloadFailed: '圖片下載失敗',
    imageCopyFailed: '圖片複製失敗',
    openImage: '開啟圖片',
    copyImage: '複製圖片',
    copyingImage: '正在複製圖片',
    downloadImage: '下載圖片',
